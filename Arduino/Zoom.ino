...
void loop() {
  if (irrecv.decode(&results)) {
    ...
    if(results.value != 0xFB55006D){
      ...
      if (results.value == 0xFB55006E || results.value == 0xC17A6BCA ||
        results.value == 0xD0F2065C || results.value == 0x3260E1FA || 
        results.value == 0xE8C2F766 || results.value == 0xF1C5A492 ||
        results.value == 0x803AB4BC || results.value == 0xA9BFDFB2 ||
        results.value == 0x1A5A7858 || results.value == 0xC7112A88) { // Reemplaza con el código IR para zoom in
